...
[![npm version](https://img.shields.io/npm/v/@puzige/acp-router.svg)](https://www.npmjs.com/package/@puzige/acp-router)
...
```bash
npx @puzige/acp-router
```

Or install globally and run:

```bash
npm install -g @puzige/acp-router
acp-router
```
...
```bash
git clone https://github.com/puzige/acp-router.git
cd acp-router
pnpm install
```
